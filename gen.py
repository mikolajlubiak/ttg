...
def gen():
	...
	try:
		...
		url = "https://nojs-game3-prod-eu-west-1.arkoselabs.com/fc/api/nojs/?pkey=TOK3N&lang=eng"
		headers = {
				...
				if x.json()['response'] == 'correct':
					def validate_username():
											...
											if idd == "true":
												...
												"arkose": {
												"token": f"{id}|r=us-west-2|metabgclr=transparent|guitextcolor=%23000000|metaiconclr=%23757575|meta=3|lang=en|pk=TOK3N|at=40|sup=1|rid=25|atp=2|cdn_url=https://cdn.arkoselabs.com/fc|lurl=https://audio-us-west-2.arkoselabs.com|surl=https://client-api.arkoselabs.com"
												}}
...
$$ |     $$ |  $$ |$$ |  $$ |$$ |$$  __$$ |$$  _$$<
$$$$$$$$\\$$$$$$  |$$$$$$$  |$$ |\$$$$$$$ |$$ | \$$\\
\________|\______/ \_______/ \__| \_______|\__|  \__|
